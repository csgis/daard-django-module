...
update_sql = f"UPDATE public.{layername} " \
             ...
             "adults=%s, subadults=%s, disease=%s, age_class=%s, age=%s, age_freetext=%s, " \
             ...
             "chronology=%s, chronology_method=%s,chronology_freetext=%s, dating_method=%s, size_from=%s, " \
             "size_to=%s, size_method=%s, dna_analyses=%s, dna_analyses_link=%s, published=%s, " \
...
insert_sql = f"INSERT INTO public.{layername} " \
             ...
             "age_class, age, age_freetext, sex, sex_freetext, bone_relations, reference_images, " \
             ...
             "storage_place_freetext, chronology, chronology_method, chronology_freetext, " \
             "dating_method, size_from, size_to, size_method, dna_analyses, dna_analyses_link, " \
             "published, doi, c_bones, c_no_o_bones, c_b_t_bc_rel, c_technic, svgid, " \
             "\"references\", comment, differential_diagnosis) " \
             "VALUES " \
             "(ST_MakePoint(%s, %s), %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, " \
